...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-slate-600 text-gray-300">
      <div>
        <img src={Logo} alt="Samar Karanch" style={{ width: "50px" }} />
      </div>
      {/*Desktop Menu*/}
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <a
              ...
              href="https://www.linkedin.com/in/samarkaranch/" target="_blank"
            >
          ...
          <li className="w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-gray-900">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/SamarKaranch" target="_blank"
            >
